 ...
 *
 * تُحدَّث الشارة عبر استطلاع دوري للخادم (كل 4 ثوانٍ) وأيضاً عند عودة
 * المستخدم إلى التبويب (visibilitychange)، فتختفي وحدها بمجرد أن يردّ
 * الطبيب على الطلب من appointments.html.
 *
 * 4 ثوانٍ اختيرت عمداً بدل تحديث كل ثانية: تبقي الشارة قريبة جداً من
 * الفورية للمستخدم، لكن بربع عدد الطلبات فقط (900 طلب/ساعة بدل 3600 لكل
 * صفحة مفتوحة)، حفاظاً على حصة الساعات المجانية في استضافة Render.
 *
